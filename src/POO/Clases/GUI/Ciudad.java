...
public class Ciudad extends javax.swing.JFrame {
    ...
    public void capturarDatos(){
        ciudades.setIdCiud(Integer.parseInt(txtId.getText()));
        ciudades.setDesCiud(txtDescrip.getText());
        ciudades.setComCiud(txtComen.getText());

        
        JOptionPane.showMessageDialog(this,"ID: "+ ciudades.getIdCiud()+" " +"Descripción:  " +ciudades.getDesCiud()+" " +"Comentario:  "+ciudades.getComCiud());
    } 
